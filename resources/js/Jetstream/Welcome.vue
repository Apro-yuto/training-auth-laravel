    ...
    <div>
        <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
            ...
            <div class="mt-6 text-gray-500">
                ...
                application. Laravel is designed to help you build your application using a
                development environment that is simple, powerful, and enjoyable. We believe you
            ...
            <div class="p-6 border-t border-gray-200">
                ...
                <div class="ml-12">
                    <div class="mt-2 text-sm text-gray-500">
                        ...
                        build and maintain fresh, modern designs with this wonderful framework at
                        your fingertips.
                    </div>
                </div>
            </div>
            ...
            <div class="p-6 border-t border-gray-200 md:border-l">
                ...
                <div class="ml-12">
                    <div class="mt-2 text-sm text-gray-500">
                        ...
                        as well as support for user email verification and resetting forgotten
                        passwords. So, you're free to get started what matters most: building your
                        application.
                    </div>
                </div>
            </div>
